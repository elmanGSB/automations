...
- client-<company-slug>: Active paid consulting or delivery engagement with a specific external company that is already a client (not a sales prospect) — planning sessions, working meetings, and status updates about work being done FOR them. Build the slug from the company name, e.g. client-francisco-foods. Distinct from customer-discovery: customer-discovery is exploratory research with prospects who are NOT yet paying for delivery work; client-<company> is ongoing engagement work for a company already being served. Always reuse the exact same slug for the same company across meetings.
